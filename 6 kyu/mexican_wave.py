# Introduction The wave (known as the Mexican wave in the English-speaking world outside North America) is an example
...
# sport field, and so the wave is able to travel continuously around the arena; in discontiguous seating
...
# although simultaneous, counter-rotating waves have been produced. (Source Wikipedia) Task In this simple Kata your
# task is to create a function that turns a string into a Mexican Wave. You will be passed a string and you must
# return that string in an array where an uppercase letter is a person standing up. Rules 1.  The input string will
# always be lower case but maybe empty.
#
