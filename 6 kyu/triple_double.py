# Write a function
#
# triple_double(num1, num2) which takes numbers num1 and num2 and returns 1 if there is a straight triple of a number
...
def triple_double(num1, num2):
    for i in set(str(num1)):
        pattern = i * 3
        pattern2 = i * 2
        if (pattern in str(num1)) and (pattern2 in str(num2)):
            return 1
    return 0
